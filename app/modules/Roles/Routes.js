module.exports = (app, express) => {
    ...
    // });
    router.post('/getRoleColumnValues', Globals.isAdminAuthorised(), Validators.fieldsValidator(), Validators.validate, async (req, res, next) => {
        const userObj = (new Controller()).boot(req, res);
