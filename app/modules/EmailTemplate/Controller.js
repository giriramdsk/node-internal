...
class EmailTemplateController extends Controller {
    ...
    async listEmail() {
        try {
            ...
            this.req.body['columnKey'] = 'emailListing';
    ...
    ********************************************************/
    ...
    /********************************************************
     ...
     Parameter:
     {
        columns: [{key : 'emailContent', status: false}, {key : 'emailKey', status: false},{key : 'subject', status: true}]
     }
     Return: JSON String
     ********************************************************/
    async saveColumnSettings() {
        try {
            this.req.body['key'] = 'emailListing';
